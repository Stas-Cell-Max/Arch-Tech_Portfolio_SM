!function (t) {
    ...
    // Function to parse different types of lengths (percentage, vh, px) and convert them
    function e(t, e, n) {
        if (typeof t === "string") {
            if (t.slice(-1) === "%") {
                t = parseInt(t.substring(0, t.length - 1)) / 100 * e;
            } else if (t.slice(-2) === "vh") {
                t = parseInt(t.substring(0, t.length - 2)) / 100 * n;
            } else if (t.slice(-2) === "px") {
    ...
    // Cache window object and initialize some variables
    var n = t(window),
        i = 1,
        o = {};
    ...
    jQuery.fn.scrollex = function (l) {
        ...
        // Set up the mode for when scrollex should trigger
        switch (u.mode) {
            case "top":
        ...
        // Handler function
        c = function (t) {
            var i, o, l, s, r, a, u = this.state, h = false, c = this.$element.offset();
        ...
        // Save the scrollex data for this element
        p = {
            id: a,
            options: u,
            test: h,
    ...
    // jQuery plugin for removing scrollex
    jQuery.fn.unscrollex = function () {
        ...
        // Remove scrollex from this element
